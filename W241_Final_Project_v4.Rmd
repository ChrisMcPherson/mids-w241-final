...
#d <- d[!is.na(no)] # Just drop row with missing values
>>>>>>> 3ddecc6c5963e047673520317d7f05449f2a927a
...
Recode missing covariate values
```{r}
...
```{r}
# If duplicate, only retain first email sent
...
# Added by NC. Work to find treatment response rate required to reject null
